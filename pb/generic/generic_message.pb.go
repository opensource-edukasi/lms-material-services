...
const file_generic_generic_message_proto_rawDesc = "" +
	"\n" +
	"\x1dgeneric/generic_message.proto\x12\x15lms_material_services\"\x0e\n" +
	"\fEmptyMessage\"\x14\n" +
	"\x02Id\x12\x0e\n" +
	...
	"\x04sort\x18\x05 \x01(\tR\x04sortB)Z'lms-material-service/pb/generic;genericb\x06proto3"

var (
	file_generic_generic_message_proto_rawDescOnce sync.Once
	file_generic_generic_message_proto_rawDescData []byte
)

func file_generic_generic_message_proto_rawDescGZIP() []byte {
	file_generic_generic_message_proto_rawDescOnce.Do(func() {
		file_generic_generic_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_generic_generic_message_proto_rawDesc), len(file_generic_generic_message_proto_rawDesc)))
	})
...
var file_generic_generic_message_proto_goTypes = []any{
	(*EmptyMessage)(nil),  // 0: lms_material_services.EmptyMessage
	(*Id)(nil),            // 1: lms_material_services.Id
	(*StringMessage)(nil), // 2: lms_material_services.StringMessage
	(*BoolMessage)(nil),   // 3: lms_material_services.BoolMessage
	(*Pagination)(nil),    // 4: lms_material_services.Pagination
}
...
func file_generic_generic_message_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_generic_generic_message_proto_rawDesc), len(file_generic_generic_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
