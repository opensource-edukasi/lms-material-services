...
import (
	...
	"lms-material-service/internal/config"
	"lms-material-service/internal/middleware"
	"lms-material-service/internal/pkg/db/postgres"
	"lms-material-service/internal/pkg/db/redis"
	"lms-material-service/internal/route"
)
